...
export function LoadTransform(sharedTypedArray: Int32Array, i, transform = $transform) {
    const ix = i * 16
...
export function SetTransform(sharedTypedArray: Int32Array, i, transform = $transform) {
    const ix = i * 16
