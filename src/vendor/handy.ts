...
import { poses as posesLeft } from './hand-poses-left'
import { poses as posesRight } from './hand-poses-right'
    ...
    return posesList
      .reduce(function (list, pose) {
        return list.concat({
          name: pose.name,
          /* @ts-ignore */
          distance: Handy.hands.getLeft().comparePoses('Fist', pose.name),
        })
      }, [])
      .sort(function (a, b) {
        return a.distance - b.distance
