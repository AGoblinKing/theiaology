...
static createAsset(builder:flatbuffers.Builder, nameOffset:flatbuffers.Offset, dataOffset:flatbuffers.Offset):flatbuffers.Offset {
  Asset.startAsset(builder);
  Asset.addName(builder, nameOffset);
  Asset.addData(builder, dataOffset);
